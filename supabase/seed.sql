...
INSERT INTO chat_monitor.conversation
    (subject, is_archived, is_public)
VALUES
    ('Project Discussion', FALSE, TRUE),
...
INSERT INTO chat_monitor.conversation
    (subject, is_archived, is_public)
VALUES
    ('Minh''s Personal Notes', FALSE, FALSE),
    ('Minh''s Team Updates', FALSE, TRUE);

-- Insert random participations
INSERT INTO chat_monitor.participation
    (user_id, conversation_id, mute_notification, display_name)
VALUES
    ('11111111-1111-1111-1111-111111111111', 1, FALSE, 'Minh'),
    ('22222222-2222-2222-2222-222222222222', 1, FALSE, 'Dani'),
    ('33333333-3333-3333-3333-333333333333', 2, TRUE, 'Julia'),
    ('44444444-4444-4444-4444-444444444444', 2, FALSE, 'Logan'),
    ('55555555-5555-5555-5555-555555555555', 3, FALSE, 'Leila'),
    ('11111111-1111-1111-1111-111111111111', 3, TRUE, 'Minh'),
    ('22222222-2222-2222-2222-222222222222', 4, FALSE, 'Dani'),
    ('33333333-3333-3333-3333-333333333333', 5, FALSE, 'Julia'),
    ('11111111-1111-1111-1111-111111111111', 6, FALSE, 'Minh'),
    ('11111111-1111-1111-1111-111111111111', 7, FALSE, 'Minh');

-- Insert random invitations
INSERT INTO chat_monitor.invitation
...
INSERT INTO chat_monitor.message
...
VALUES
    ...
    ('I''ll start with my progress on the feature.', 7),
